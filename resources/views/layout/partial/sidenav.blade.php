<!-- sidenav  -->
<aside class="fixed mt-6 inset-y-0 flex-wrap items-center justify-between block w-full p-0 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
    <div class="h-19">
    ...
    <div class="items-center block w-auto max-h-screen h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="w-full mt-4">
          <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase dark:text-white opacity-60">Menu</h6>
        </li>

        <li class="mt-0.5 w-full">
          <a class="active:text-white active:bg-blue-500 hover:shadow-xs hover:-translate-y-px border-b py-1 px-4 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap text-slate-700" href="index">
        ...
        <li class="mt-0.5 w-full">
          <a class="active:text-white active:bg-blue-500 hover:shadow-xs hover:-translate-y-px border-b py-1 text-sm my-0 mx-2 flex items-center whitespace-nowrap px-4" href="#lab">
            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
              <i class="relative top-0 text-sm leading-normal text-blue-500 ni ni-tv-2"></i>
            </div>
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Profile Laboratorium</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          {{-- <a class="border-b py-1 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="{{ route('dosen', ['labid' => $lab->nama_lab]) }}"> --}}
            <a class="active:text-white active:bg-blue-500 hover:shadow-xs hover:-translate-y-px py-1 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4" href="{{ url('/dosen#dosen-$lab->nama_lab') }}">
            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
              <i class="relative top-0 text-sm leading-normal text-red-600 ni ni-paper-diploma"></i>
            </div>
            {{-- <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Dosen Laboratorium {{ $lab->nama_lab }}</span> --}}
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Daftar Dosen Laboratorium</span>
          </a>
        </li>
