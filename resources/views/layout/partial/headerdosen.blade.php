...
<nav class="relative flex flex-wrap items-center justify-between transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start" navbar-main navbar-scroll="false">
    <div class="flex items-center justify-between w-full mx-auto flex-wrap-inherit">
      <div class="justify-end p-1 px-5 flex items-center  grow sm:mt-0 sm:mr-6 md:mr-0">
        <div class="flex items-center md:ml-auto md:pr-4">
          <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease">
            <button
                class="toggle-button w-10 h-6 rounded-full bg-slate-100 dark:bg-slate-600 relative transition-colors duration-500 ease-infocus:outline-none  focus:border-transparent">
                  <div id="toggle"
                    class="flex items-center rounded-full w-4 h-4 relative ml-1 dark:ml-5 pointer-events-none transition-all duration-300 ease-out">
                    <svg class="block dark:hidden" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
