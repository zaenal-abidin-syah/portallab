    ...
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
      <nav>
        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
          <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']" aria-current="page">Kegiatan</li>
        </ol>
      ...
      <div class="justify-end flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0">
        <div class="flex items-center md:ml-auto md:pr-4">
          <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease">
            <button
                class="flex items-center toggle-button w-14 h-8 rounded-full bg-slate-100 dark:bg-slate-600 relative transition-colors duration-500 ease-infocus:outline-none  focus:border-transparent">
                  <div id="toggle"
                    class="rounded-full w-6 h-6 relative ml-2 dark:ml-7 pointer-events-none transition-all duration-300 ease-out">
