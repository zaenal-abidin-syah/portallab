  ...
  <div class="flex flex-wrap -mx-3 gap-2 md:gap-3">
      ...
      <div class="w-full">
        <div class="">
          <div class="p-4 md:p-6 text-center flex flex-col items-center">
            ...
            <p class="text-sm md:text-xl text-slate-500 dark:text-slate-200">NIP: {{ $dosen->nip }}</p>
            <p class="text-sm md:text-xl italic text-blue-500 dark:text-blue-700">{{ $dosen->email }}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="w-full max-w-full md:w-7/12 shadow-lg rounded-xl bg-white dark:bg-slate-850 p-6">
      <div class="">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
          <div>
            <span class="block text-sm md:text-base font-semibold text-slate-700 dark:text-slate-100">Jenjang</span>
            <span class="text-xs md:text-sm mt-1 block w-full rounded-md border-none text-slate-700 dark:text-slate-200">{{ $dosen->jenjang }}</span>
          </div>
          <div>
            <span class="block text-sm md:text-base font-semibold text-slate-700 dark:text-slate-100">Universitas</span>
            <span class="text-xs md:text-sm mt-1 block w-full rounded-md border-none  text-slate-700 dark:text-slate-200">{{ $dosen->universitas }}</span>
          </div>
        </div>
        ...
        <div>
          <span class="block text-sm font-semibold text-slate-700 dark:text-slate-100">Jabatan Terakhir</span>
          <span class="text-xs  md:text-sm mt-1 block w-full rounded-md border-none text-slate-700 dark:text-slate-200">
